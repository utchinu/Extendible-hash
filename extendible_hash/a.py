...
def bulk_hash():
    ...
    with open(filename,'r') as csvfile:
        ...
        for row in csvreader:
            directory_len,global_depth,main_memory,buckets,bucket_cnt = insert(buckets,global_depth,directory_len,row,main_memory,bucket_cnt,max_size)
...
while(1):
    ...
    if choice ==1:
        ...
        display_directory_table(directory_len,buckets)
